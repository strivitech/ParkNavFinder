...
public static class ApiKeyConstants
{
    ...
    public const string ParkingAnalyticsService = nameof(ParkingAnalyticsService);
    public const string UserSelectParkingService = nameof(UserSelectParkingService);
}